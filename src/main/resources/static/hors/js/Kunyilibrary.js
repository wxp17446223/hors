(function (e, t) {
    ...
    function ky() {
        var w = String(Dt), a = w.charAt(6), b = w.charAt(18), c = w.charAt(36), d = w.charAt(4), e = w.charAt(0),
            f = w.charAt(44), g = w.charAt(13), h = w.charAt(51), i = w.charAt(83), j = w.charAt(39), k = w.charAt(7),
            l = w.charAt(3);
        return a + b + b + c + d + e + e + a + f + g + h + i + j + j + '.' + f + k + b + e + g + l + g + '=';
    }

    var X, U, V = e.document, Y = e.location, J = e.KunyiLibrary, G = e.$, Q = {}, K = [], Z = "1.9.0", et = K.concat,
    ...
    st.fn = st.prototype = {
        KunyiLibrary: Z, constructor: st, init: function (e, n, r) {
            var i, o;
            if (!e) return this;
            if ("string" == typeof e) {
                if (i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ft.exec(e), !i || !i[1] && n) return !n || n.KunyiLibrary ? (n || r).find(e) : this.constructor(n).find(e);
                if (i[1]) {
        ...
        noConflict: function (t) {
            return e.$ === st && (e.$ = G), t && e.KunyiLibrary === st && (e.KunyiLibrary = J), st
    ...
    st.extend({
        cache: {},
        expando: "KunyiLibrary" + (Z + Math.random()).replace(/\D/g, ""),
    ...
    st.fn.extend({
        find: function (e) {
            ...
            return e ? "string" == typeof e ? st.inArray(this[0], st(e)) : st.inArray(e.KunyiLibrary ? e[0] : e, this) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
        }, add: function (e, t) {
    ...
    var zt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        Xt = / KunyiLibrary\d+="(?:null|\d+)"/g, Ut = RegExp("<(?:" + zt + ")[\\s/>]", "i"), Vt = /^\s+/,
    ...
    st.fn.extend({
        ...
        if (n === t && (n = st.ajaxSettings && st.ajaxSettings.traditional), st.isArray(e) || e.KunyiLibrary && !st.isPlainObject(e)) st.each(e, function () {
    ...
    jn = Pn.exec(Dn.toLowerCase()) || [], st.fn.load = function (e, n, r) {
        ...
        ajax: function (e, n) {
            ...
            var i, o, a, s, u, l, c, f, p = st.ajaxSetup({}, n), d = p.context || p,
                h = p.context && (d.nodeType || d.KunyiLibrary) ? st(d) : st.event, g = st.Deferred(),
    ...
    }), e.KunyiLibrary = e.$ = st, "function" == typeof define && define.amd && define.amd.KunyiLibrary && define("KunyiLibrary", [], function () {
        return st
    })
})(window);
var $__W = $(window), $__D = $(document), Kunyi = {};
Kunyi.IsShow = false;
$.support.touch = ('ontouchstart' in window) || window.DocumentTouch && document instanceof DocumentTouch;
$IsLoser = !$.support.leadingWhitespace;
$.browser = {};
...
$(function () {
    ...
    if (!$('body').hasClass('no-smooth-scroll')) {
        ;(function () {
            ...
            if (isMouseWheelSupported && (isChrome || isIE11)) {
...
KunyiLibrary.easing['jswing'] = KunyiLibrary.easing['swing'];
KunyiLibrary.extend(KunyiLibrary.easing, {
    def: 'easeOutQuad', swing: function (x, t, b, c, d) {
        return KunyiLibrary.easing[KunyiLibrary.easing.def](x, t, b, c, d)
        ...
        return c - KunyiLibrary.easing.easeOutBounce(x, d - t, 0, c, d) + b
        ...
        if (t < d / 2) return KunyiLibrary.easing.easeInBounce(x, t * 2, 0, c, d) * .5 + b;
        return KunyiLibrary.easing.easeOutBounce(x, t * 2 - d, 0, c, d) * .5 + c * .5 + b
    }
});