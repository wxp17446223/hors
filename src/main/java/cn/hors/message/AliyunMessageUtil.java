...
public class AliyunMessageUtil {
    ...
    private static final String accessKeyId = "LTAI4G4CgaNDEAVqpCHkjRyE";
    private static final String accessKeySecret = "8bgYxb2Ta15V2wuelgpEptnWnQ9XS4";
